...
HD_PWD='D:/Privat/EDS/Projects/Labor/Labor_3_neu/Labor_3_neu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PZG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PZG.tcl -notrace
