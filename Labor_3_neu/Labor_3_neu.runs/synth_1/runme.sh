...
HD_PWD='D:/Privat/EDS/Projects/Labor/Labor_3_neu/Labor_3_neu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PZG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PZG.tcl
