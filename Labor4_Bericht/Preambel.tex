...
\usepackage{csquotes}								%deutsche Quotes mit ff Zeile
\MakeOuterQuote{"}
...
\usepackage{caption}
\usepackage{subcaption}                             % multi captions
...
\usetikzlibrary{math, calc, automata, positioning, arrows, shapes.geometric}
