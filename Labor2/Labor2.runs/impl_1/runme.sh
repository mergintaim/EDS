...
HD_PWD='D:/Privat/EDS/Projects/Labor/Labor2/Labor2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uhr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uhr.tcl -notrace
