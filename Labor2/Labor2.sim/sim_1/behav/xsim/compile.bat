...
REM
REM Generated by Vivado on Sat May 07 23:22:18 +0200 2022
...
echo "xvhdl --incr --relax -prj tb_Uhr_vhdl.prj"
call xvhdl  --incr --relax -prj tb_Uhr_vhdl.prj -log xvhdl.log
